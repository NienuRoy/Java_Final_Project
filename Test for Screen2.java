...
public class Testcase extends JFrame implements CustomerVehicleSearchInterface {
    ...
    private String strTitle,strPrice,strType,strCateg,strUrl;
    ...
    private java.util.List<Vehicle> result = null;
