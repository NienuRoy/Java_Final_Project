 ...
 */
public class Screen2Center extends JFrame {
   ...
   // String strTitle,strPrice,strType,strCateg,strUrl;
    ...
    public void screen2centerAdd() {

        for (int i = 0; i < 10; i++) {

            String strTitle = "Title:" + i;
            String strPrice = "Price:" + i;
            String strType = "Type:" + i;
            String strCateg = "Categ:" + i;
    ...
    public static void main(String[] args) throws Exception {
        Screen2Center s2l = new Screen2Center();
        s2l.screen2centerAdd();
        s2l.setVisible();
    }
}
